...
class DevicePulseTimeline extends LitElement {
    ...
    render() {
        ...
        // Fit card to available rows option is empty or different from auto. CSS will handle overflow with scrollbars.
...
console.info(
    `%c DEVICE-PULSE-TIMELINE-CARD %c v${CARD_VERSION} `,
